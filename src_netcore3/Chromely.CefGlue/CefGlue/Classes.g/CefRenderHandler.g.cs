...
namespace Xilium.CefGlue
{
    ...
    public abstract unsafe partial class CefRenderHandler
    {
        ...
        private cef_render_handler_t.on_cursor_change_delegate _dsc;
        ...
        protected CefRenderHandler()
        {
            ...
            _dsc = new cef_render_handler_t.on_cursor_change_delegate(on_cursor_change);
            _self->_on_cursor_change = Marshal.GetFunctionPointerForDelegate(_dsc);
