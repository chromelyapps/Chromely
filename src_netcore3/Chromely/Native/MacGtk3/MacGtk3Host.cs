...
{
    public class MacGtk3Host : INativeHost
    {
        ...
        public IntPtr CreateNewWindow(GtkWindowType type)
        {
            ...
            {
                Log.Error("Error in MacGtk3Host::CreateNewWindow");
                Log.Error(exception);
            }
        ...
        public IntPtr GetGdkHandle()
        {
            ...
            {
                Log.Error("Error in MacGtk3Host::GetGdkHandle");
                Log.Error(exception);
            }
        ...
        public IntPtr GetNativeHandle()
        {
            ...
            {
                Log.Error("Error in MacGtk3Host::GetNativeHandle");
                Log.Error(exception);
            }
        ...
        public void Init(int argc, string[] argv)
        {
            ...
            {
                Log.Error("Error in MacGtk3Host::Init");
                Log.Error(exception);
            }
        }
        ...
        public void ShowWindow()
        {
            ...
            {
                Log.Error("Error in MacGtk3Host::ShowWindow");
                Log.Error(exception);
            }
        }
        ...
        public void Run()
        {
            ...
            {
                Log.Error("Error in MacGtk3Host::Run");
                Log.Error(exception);
            }
        }
        ...
        public Size GetWindowSize()
        {
            ...
            {
                Log.Error("Error in MacGtk3Host::GetWindowSize");
                Log.Error(exception);
            }
        ...
        public void SetWindowTitle(string title)
        {
            ...
            {
                Log.Error("Error in MacGtk3Host::SetWindowTitle");
                Log.Error(exception);
            }
        }
        ...
        public void SetWindowDefaultSize(int width, int height)
        {
            ...
            {
                Log.Error("Error in MacGtk3Host::SetWindowDefaultSize");
                Log.Error(exception);
            }
        }
        ...
        {
            internal const string GtkLib = "libgtk-3.0.dylib";
            internal const string GObjLib = "libgobject-2.0.0.dylib";
            ...
            [DllImport(QuartzLib, CallingConvention = CallingConvention.Cdecl)]
