...
namespace Chromely.Core
{
    ...
    public class ChromelyConfiguration
    {
        ...
        private string _appExeLocation;

        /// <summary>
        /// Gets or sets location of the entry exe
        /// </summary>
        public string AppExeLocation 
        { 
            get
            {
                if (string.IsNullOrWhiteSpace(_appExeLocation))
                {
                    _appExeLocation = AppDomain.CurrentDomain.BaseDirectory;
                }

                return _appExeLocation;
            }
            set
            {
                _appExeLocation = value;
            }
        }
        ...
        {
            RegisterMessageRouterHandler(new ChromelyMessageRouter(messageRouterHandler));
            return this;
        }
