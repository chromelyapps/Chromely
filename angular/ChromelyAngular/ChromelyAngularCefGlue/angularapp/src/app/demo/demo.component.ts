...
export class DemoComponent implements OnInit {
    ...
    constructor(private _messagerouterService: MessagerouterService,
     ...
     */
    cefQueryRequests(type: string, url: string): void {
        switch (type) {
            case "getlocal":
                this._messagerouterService.cefQueryGetRequest(url, null, data => {
                    this._zone.run(
                        () => {
            ...
            case "getexternal":
                ...
                break;
            case "post":
                this._messagerouterService.cefQueryPostRequest(url, null, this.postData, result => {
                    this._zone.run(
                        () => {
