    ...
    public partial class LinuxNativeMethods
    {
        public static void SetDefaultWindowVisual(IntPtr widget)
        {
            ...
            try
            {
                ...
                {
                    Logger.Instance.Log.Warn("Warning in LinuxNativeMethods::SetDefaultWindowVisual: List of visuals is invalid.");
                    return;
                }
            ...
            {
                Logger.Instance.Log.Error("Error in LinuxNativeMethods::SetDefaultWindowVisual");
